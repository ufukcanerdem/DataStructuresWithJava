...
public class Main {
     ...
     */
	  public static void main(String args[]){
		  ...
		  ((House)s1.buildings[0][s1.HouseCount-1]).setColor("red");
		  ((House)s1.buildings[0][s1.HouseCount-1]).setRoom(3);
		  
		  s1.addBuilding(0,1,3,1,3);
		  ((House)s1.buildings[0][s1.HouseCount-1]).setColor("blue");
		  ((House)s1.buildings[0][s1.HouseCount-1]).setRoom(5);
		  
		  s1.addBuilding(0,0,9,3,3);
		  ((House)s1.buildings[0][s1.HouseCount-1]).setColor("pink");
		  ((House)s1.buildings[0][s1.HouseCount-1]).setRoom(7);
		  ...
		  ((Office)s1.buildings[1][s1.OfficeCount-1]).setJobType("Bank");
		  
		  s1.addBuilding(3, 0, 211, 30, 3);
		  
		  s1.addBuilding(1,0,70,3,3);
		  ((Office)s1.buildings[1][s1.OfficeCount-1]).setJobType("Engineer");
		  
		  s1.addBuilding(2,0,39,3,3);
		  ((Market)s1.buildings[2][s1.MarketCount-1]).setOpenTime("09.00");
		  ((Market)s1.buildings[2][s1.MarketCount-1]).setCloseTime("21.00");
		  
		  s1.addBuilding(1,1,52,3,3);
		  ((Office)s1.buildings[1][s1.OfficeCount-1]).setJobType("Technology");
		  ...
		  while(true) {
			try {
				System.out.println("Press 1 for edit menu, press 2 for viewing menu!");
		  			...
		  			try {
		  				...
		  				switch(editin) {
		  					case 1:	
		  						...
		  						if(s1.isInputsCorrect(prm2, prm3, prm4) == true) {
		  							...
		  							if(prm1 == 0) {
		  								...
		  								sc.nextLine();
		  							try {
		  								((House)s1.buildings[0][s1.HouseCount-1]).setOwnerName(temp1); //Using typecast for edit ownername of subclass
		  							}
		  								...
		  								temp1=sc.nextLine();
		  								((House)s1.buildings[0][s1.HouseCount-1]).setColor(temp1); //Using typecast for edit color of subclass
		  							}
		  							else if(prm1==1) {
		  								System.out.println("Enter the owner name:");
		  								temp1=sc.nextLine();
		  								sc.nextLine();
		  							try {
		  								((Office)s1.buildings[1][s1.OfficeCount-1]).setOwnerName(temp1); //Using typecast for edit ownername of subclass
		  							}
		  							catch(ArrayIndexOutOfBoundsException e){
		  								...
		  								temp1=sc.nextLine();
		  							try {
		  								((Office)s1.buildings[1][s1.OfficeCount-1]).setJobType(temp1); //Using typecast for edit jobtype of subclass
		  							}
		  							catch(ArrayIndexOutOfBoundsException e){
		  								System.out.println("There is no office!!!");
		  							}
		  								...
		  								sc.nextLine();
		  							try {
		  								((Market)s1.buildings[2][s1.MarketCount-1]).setOwnerName(temp1); //Using typecast for edit ownername of subclass
		  							}
		  							catch(ArrayIndexOutOfBoundsException e){
		  								...
		  								temp1=sc.nextLine();
		  							try {
		  								((Market)s1.buildings[2][s1.MarketCount-1]).setOpenTime(temp1); //Using typecast for edit opentime of subclass
		  							}
		  							catch(ArrayIndexOutOfBoundsException e){
		  								System.out.println("There is no market!!!");
		  							}
		  								...
		  								temp1=sc.nextLine();
		  							try {	
		  								((Market)s1.buildings[2][s1.MarketCount-1]).setCloseTime(temp1); //Using typecast for edit closetime of subclass
		  							}
		  							catch(ArrayIndexOutOfBoundsException e){
		  								System.out.println("There is no market!!!");
		  							}
