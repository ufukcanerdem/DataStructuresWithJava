...
public class Street implements StreetOperations {
	...
	private List<LinkedList<Integer> > filledPos = new LinkedList<LinkedList<Integer> >();  //Keeps the positions is filled.
	private List<LinkedList<Integer> > filledHeight = new LinkedList<LinkedList<Integer> >(); //Keeps the heights is filled. 
	public List<LinkedList<Building> > buildings = new LinkedList<LinkedList<Building> >(); //Keeps the Buildings,[0][x] is house,[1][x] is office, [2][x] is market.It can keep any type of buildings.(Polymorphism)
	public List<Playground> playgrounds = new LinkedList<Playground>();
	...
	public Street() {
		...
		LinkedList<Integer> elem11 = new LinkedList<Integer>();
		LinkedList<Integer> elem22 = new LinkedList<Integer>();
		for(int y=0; y < 999; y++) {
			elem11.add(-1);
			elem22.add(-1);
		}
		...
		LinkedList<Building> elem31 = new LinkedList<Building>();
		LinkedList<Building> elem32 = new LinkedList<Building>();
		LinkedList<Building> elem33 = new LinkedList<Building>();
