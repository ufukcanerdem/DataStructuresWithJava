...
/**
 * Driver and main of HW3_LDLinkedList
 *
 * @author UfukcanErdem
 * @version 1.0.0
 * @since  20.03.2022
...
public class Main {
     ...
     */
	  public static void main(String args[]){
		  /**
		   * In first part of main function, program running and testing with given inputs automatically.
		   */
		  ...
		  Street sTest100 = new Street();
		  sTest100.setStreetLen(1000);
		  
		  double start1 = System.nanoTime();
	      
		  for(int x=0;x<180;x=x+2) {
			  sTest100.addBuilding(1, 1, x, 1, 10);
		  }
		  
	      double end1 = System.nanoTime();
	      double diff1=(end1-start1)/1000000;
	      System.out.println("100 structure added to street in milli seconds(LDLinkedList): "+ diff1);
	      
	      double start2= System.nanoTime();
	      
		  for(int x=1;x<90;x++) {
			  sTest100.DeleteBuilding(1, x);
		  }
		  
	      double end2 = System.nanoTime();
	      double diff2=(end2-start2)/1000000;
	      System.out.println("100 structure deleted from street in milli seconds(LDLinkedList): "+ diff2);
		  ...
		  while(true) {
			try {
				System.out.println("Press 1 for edit menu, press 2 for viewing menu!(LDLinkedList)");
