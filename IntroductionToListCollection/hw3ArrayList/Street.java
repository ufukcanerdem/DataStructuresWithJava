...
public class Street implements StreetOperations {
	...
	private List<ArrayList<Integer> > filledPos = new ArrayList<ArrayList<Integer> >();  //Keeps the positions is filled.
	private List<ArrayList<Integer> > filledHeight = new ArrayList<ArrayList<Integer> >(); //Keeps the heights is filled. 
	public List<ArrayList<Building> > buildings = new ArrayList<ArrayList<Building> >(); //Keeps the Buildings,[0][x] is house,[1][x] is office, [2][x] is market.It can keep any type of buildings.(Polymorphism)
	public List<Playground> playgrounds = new ArrayList<Playground>();
	 ...
	 */
	public Street() {
		ArrayList<Integer> elem1 = new ArrayList<Integer>();
		...
		ArrayList<Integer> elem11 = new ArrayList<Integer>();
		ArrayList<Integer> elem22 = new ArrayList<Integer>();
		for(int y=0; y < 999; y++) {
			elem11.add(-1);
			elem22.add(-1);
		}
		...
		ArrayList<Building> elem31 = new ArrayList<Building>();
		ArrayList<Building> elem32 = new ArrayList<Building>();
		ArrayList<Building> elem33 = new ArrayList<Building>();
	...
	public void DeleteBuilding(int paramBuildingType, int paramListNumber) {
		...
		if(paramBuildingType==0 || paramBuildingType==1 || paramBuildingType==2) {
			...
			if(buildings.get(paramBuildingType).get(index) == null) {
				...
				buildings.get(paramBuildingType).remove(index);
